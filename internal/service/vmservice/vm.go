...
func skipQemuGuestCheck(mc *scope.MachineScope) bool {
	if mc.ProxmoxMachine.Spec.Checks != nil {
		return ptr.Equal(ptr.To(true), mc.ProxmoxMachine.Spec.Checks.SkipQemuGuestAgent)
...
func skipCloudInitCheck(mc *scope.MachineScope) bool {
	if mc.ProxmoxMachine.Spec.Checks != nil {
		return ptr.Equal(ptr.To(true), mc.ProxmoxMachine.Spec.Checks.SkipCloudInitStatus)
	}
